...
#pragma mark Cells
- (SidebarItemCell *)selectedItem {
    return self.matrix.selectedCell;
}
- (void)setSelectedItem:(SidebarItemCell *)selectedItem {
    self.selectedIndex = [[self.matrix cells] indexOfObject:selectedItem];
}
- (int)selectedIndex {
    SidebarItemCell *cell = [self selectedItem];
...
+ (Class)sidebarItemCellClass {
    return [SidebarItemCell class];
}
- (SidebarItemCell *)addItemWithImage:(NSImage *)image target:(id)target action:(SEL)action {
    SidebarItemCell *cell = [[[self.class sidebarItemCellClass] alloc] initImageCell:image];
...
- (SidebarItemCell *)addItemWithImage:(NSImage *)image alternateImage:(NSImage *)alternateImage target:(id)target action:(SEL)action {
    SidebarItemCell *cell = [self addItemWithImage:image target:target action:action];
...
- (SidebarItemCell *)addItemWithImage:(NSImage *)image alternateImage:(NSImage *)alternateImage {
    SidebarItemCell *cell = [self addItemWithImage:image];
    [cell setAlternateImage:alternateImage];
    
    return cell;
}
- (void)addCell:(SidebarItemCell *)cell {
...
#pragma mark Sidebar Target Action
